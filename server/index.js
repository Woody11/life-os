...
for (const key of ['WEALTHCANVAS_URL', 'LEGO_STUDIO_URL', 'OBSIDIAN_URL', 'OBSIDIAN_TOKEN', 'OPENCLAW_GATEWAY_URL', 'OPENCLAW_HOOK_TOKEN', 'GOOGLE_ACTIONS_URL', 'GOOGLE_ACTIONS_TOKEN']) {
